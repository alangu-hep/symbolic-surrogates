...
NETWORK=${WORKDIR}/wrappers/ParticleNet.py
...
for i in "${!SIGNALS[@]}"; do
    ...
    MODEL_PATH=${WORKDIR}/outputs/models/${SIGNAL}/${MODEL_NAME}/${MODEL_NAME}_M12-PARTICLENETKD_KD_${TEACHER_NAME}_${TEMPERATURE}_epoch-4_state.pt
