...
class CNNWrapper(torch.nn.Module):
    def __init__(self, pf_features_dims, num_classes, conv_params, fc_params) -> None:
        super().__init__()
        self.mod = ResNet(pf_features_dims, num_classes,
...
def get_model(data_config, **kwargs):
    ...
    model = CNNWrapper(pf_features_dims, num_classes,
                   conv_params=conv_params,
                   fc_params=fc_params)
