...
def main():
    ...
    if args.comp == 'DL':
        ...
        model_dict = initialize_models(training=True, network=args.model_network, data_config=args.data_config)
        ...
        student_dict = initialize_models(training=True, network=args.model_network, data_config=args.data_config)
        teacher_dict = initialize_models(training=True, network=args.teacher_network, data_config=args.data_config, model_path=args.teacher_path)
        ...
        vae_dict = initialize_models(training=True, network=args.dr_network, data_config=args.data_config)
        teacher_dict = initialize_models(training=True, network=args.model_network, data_config=args.data_config, model_path=args.model_path)
        ...
        vae_dict = initialize_models(training=True, network=args.dr_network, data_config=args.data_config, model_path=args.dr_path)
        model_dict = initialize_models(training=True, network=args.model_network, data_config=args.data_config, model_path=args.model_path)
        symbolic_regression(args, loader_dict, model_dict, vae_dict)
    elif args.comp == 'LOGITS':
        _logger.info('Fetching logits for model')
        model_dict = initialize_models(training=False, network=args.model_network, data_config=args.data_config, model_path=args.model_path)
